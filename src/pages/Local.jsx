  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FFF0F5', paddingBottom: 100 }}>
      ...
      <div style={{ maxWidth: 640, margin: '0 auto', padding: '24px 16px' }}>
        <div style={{
          background: '#4CAF82', border: '3px solid #1C1C3A',
          borderRadius: 24, padding: '22px 24px',
          boxShadow: '6px 6px 0 #1C1C3A', marginBottom: 20,
        }}>
            ...
            {listings.map((item, i) => (
              <button
                ...
                style={{
                  ...
                  boxShadow: '5px 5px 0 #1C1C3A', overflow: 'hidden',
                }}
              >
                {item.images?.[0] && (
                  <img
                ...
                <div style={{ padding: '16px 18px' }}>
                  ...
                  <div style={{ fontWeight: 900, fontSize: 17, color: '#1C1C3A' }}>{item.title}</div>
                  {item.price_text && (
...
function chipStyle(active) {
  return {
    ...
    background: active ? '#FF85B3' : 'white',
    color: active ? 'white' : '#1C1C3A',
    fontWeight: 700,
    fontSize: 13,
    cursor: 'pointer',
    fontFamily: 'inherit',
    boxShadow: active ? '3px 3px 0 #1C1C3A' : '2px 2px 0 #1C1C3A',
  }
}
